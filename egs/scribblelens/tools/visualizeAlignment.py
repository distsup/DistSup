...
'''
    ...
    that will genetrate example.path

    - For debugging, here, visualizePath can generate you an image
     python ./visualizeAlignment.py --path mypath.path
'''
def getArgs():
    # construct the argument parser and parse the arguments
    ap = argparse.ArgumentParser()
    ap.add_argument("--path",    required = True, help = "Name of a path file (whcih has the image data, length, etc)")
